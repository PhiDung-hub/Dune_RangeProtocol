...
WITH
    ...
    USDC_WETH_5bps_active_weekly AS (
        SELECT
            DATE_TRUNC ('week', w.time) AS week_start,
            -- Fees
            SUM(w.fee0) as fee0,
    ...
    USDC_WETH_5bps_active AS (
        ...
        FROM
            USDC_WETH_5bps_active_weekly
    ),
    -- ADDRESS = 0x3c0ACF2AC603837eFA8B247A54b42b71e706ef71
    USDC_WETH_5bps_passive_weekly AS (
        SELECT
            DATE_TRUNC ('week', w.time) AS week_start,
            -- Fees
            SUM(w.fee0) as fee0,
    ...
    USDC_WETH_5bps_passive AS (
        ...
        FROM
            USDC_WETH_5bps_passive_weekly
    ),
    -- ADDRESS = 0x252B35419180f0f1a1B287C637f475fBaF62B053
    WETH_GALA_30bps_weekly AS (
        SELECT
            DATE_TRUNC ('week', w.time) AS week_start,
            -- Fees
            SUM(w.fee0) as fee0,
...
FROM
    ...
    FULL OUTER JOIN wstETH_WETH_5bps ON week_series.week_start = wstETH_WETH_5bps.week_start
    FULL OUTER JOIN USDC_USDT_1bps ON week_series.week_start = USDC_USDT_1bps.week_start
    FULL OUTER JOIN ANKR_WETH_30bps ON week_series.week_start = ANKR_WETH_30bps.week_start
    FULL OUTER JOIN APE_WETH_30bps ON week_series.week_start = APE_WETH_30bps.week_start
    FULL OUTER JOIN FXS_WETH_30bps ON week_series.week_start = FXS_WETH_30bps.week_start
    FULL OUTER JOIN GAL_WETH_100bps ON week_series.week_start = GAL_WETH_100bps.week_start
    FULL OUTER JOIN LDO_WETH_30bps ON week_series.week_start = LDO_WETH_30bps.week_start
    FULL OUTER JOIN LQTY_WETH_30bps ON week_series.week_start = LQTY_WETH_30bps.week_start
    FULL OUTER JOIN RNDR_WETH_100bps ON week_series.week_start = RNDR_WETH_100bps.week_start
    FULL OUTER JOIN USDC_WETH_5bps_active ON week_series.week_start = USDC_WETH_5bps_active.week_start
    FULL OUTER JOIN USDC_WETH_5bps_passive ON week_series.week_start = USDC_WETH_5bps_passive.week_start
    FULL OUTER JOIN WETH_GALA_30bps ON week_series.week_start = WETH_GALA_30bps.week_start
    FULL OUTER JOIN WETH_GRT_30bps ON week_series.week_start = WETH_GRT_30bps.week_start
ORDER BY
    week_start
    -- ORDER: 
    -- 01. ANKR_WETH_30bps AS (),
