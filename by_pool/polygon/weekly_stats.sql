...
FROM
    week_series
    FULL OUTER JOIN USDC_WETH ON week_series.week_start = USDC_WETH.week_start
    FULL OUTER JOIN WMATIC_WETH ON week_series.week_start = WMATIC_WETH.week_start
ORDER BY
    week_start
    -- ORDER: 
    -- 01. USDC_WETH AS (),
